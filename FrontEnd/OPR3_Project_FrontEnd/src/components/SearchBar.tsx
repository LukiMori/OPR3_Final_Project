    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-primary-dark/50 dark:text-dark-text/50" size={18} />
                <input
                    type="text"
                    value={query}
            ...
            {isOpen && (
                <div className="absolute z-50 w-full mt-2 bg-white dark:bg-dark-card rounded-lg shadow-2xl
                      border border-secondary-green dark:border-primary-dark max-h-96 overflow-y-auto">
                    {loading ? (
                        <div className="p-4 text-center text-primary-dark/70 dark:text-dark-text/70">
                            Searching...
                        </div>
                    ) : results.length > 0 ? (
                        <div className="py-2">
