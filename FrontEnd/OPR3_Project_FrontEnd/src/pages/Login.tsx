...
const Login = () => {
  ...
  return (
    <div
      className='min-h-screen bg-gradient-to-br from-primary-dark via-primary-dark to-accent-orange
      ...
      <div className='w-full max-w-md'>
        <div className='bg-light dark:bg-dark-card rounded-2xl shadow-2xl p-8 space-y-6'>
          <div className='text-center space-y-2'>
            ...
            <h1 className='text-3xl font-bold text-primary-dark dark:text-dark-text'>Movie List App</h1>
            <p className='text-primary-dark/70 dark:text-dark-text/70'>Sign in to your account</p>
          </div>
